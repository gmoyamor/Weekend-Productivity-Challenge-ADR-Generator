    ...
    <form onSubmit={handleSubmit} className="space-y-6" noValidate>
      ...
      <div>
        ...
        <input
          ...
          className={`w-full rounded-md border px-3 py-2 text-sm text-white placeholder-gray-500 bg-[#2A3A4A] transition-colors focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-offset-[#1A242F] ${
            errors.title && touched.title
              ? "border-red-400 focus:ring-red-300"
              : "border-[#3B4B5B] focus:ring-[#FF9900] focus:border-[#FF9900]"
          }`}
          disabled={isLoading}
        />
      ...
      <div>
        ...
        <textarea
          ...
          rows={5}
          className={`w-full rounded-md border px-3 py-2 text-sm text-white placeholder-gray-500 bg-[#2A3A4A] transition-colors focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-offset-[#1A242F] resize-y ${
        ...
        <div className="space-y-3">
          <label className="flex items-start gap-3 cursor-pointer">
            <input
              ...
              className="mt-0.5 h-4 w-4 text-[#FF9900] border-gray-600 focus:ring-[#FF9900]"
              disabled={isLoading}
            />
            <div>
              <span className="text-sm font-medium text-white">Breve</span>
      ...
      <div className="pt-2">
        <button
          type="submit"
          disabled={isLoading}
          className="w-full rounded-md bg-[#FF9900] px-4 py-2.5 text-sm font-medium text-white transition-colors hover:bg-[#FFB84D] focus:outline-none focus:ring-2 focus:ring-[#FF9900] focus:ring-offset-2 focus:ring-offset-[#1A242F] disabled:opacity-50 disabled:cursor-not-allowed"
        >
